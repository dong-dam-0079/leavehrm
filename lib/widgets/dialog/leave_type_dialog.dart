...
class LeaveTypeDialog extends StatefulWidget {
  const LeaveTypeDialog({Key? key}) : super(key: key);

  @override
  State<LeaveTypeDialog> createState() => _LeaveTypeDialogState();
}

class _LeaveTypeDialogState extends State<LeaveTypeDialog> {
  @override
